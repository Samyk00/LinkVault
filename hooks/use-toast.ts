...
const TOAST_LIMIT = 1
const TOAST_REMOVE_DELAY = 3000 // 3 seconds - enough time to read and act on undo
...
* @param {Toast} props - Configuration object that defines the toast’s content and behavior.
